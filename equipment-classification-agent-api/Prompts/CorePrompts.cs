...
{
    public static string GetSystemPrompt() => @"Using the following steps extract the following details from the images and ensure that all markings, 
        including symbols should be included:Brand Logo: store your findings in the # brand # property of the JSON structure belowColor: store the color 
